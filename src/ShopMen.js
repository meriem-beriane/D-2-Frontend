...
function ShopMen() {
  ...
  const [productss,setProducts] =useState([]);
   ...
   const getProducts = async () => {
     showLoader()
     const response = await fetch("https://asos2.p.rapidapi.com/products/v2/list?store=US&offset=0&categoryId=28295&limit=48&country=US&sort=freshness&currency=USD&sizeSchema=US&lang=en-US", {
       "method": "GET",
       "headers": {
