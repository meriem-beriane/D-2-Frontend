...
function ConverseShop() {
  ...
  const [productss,setProducts] =useState([]);
   ...
   const getProducts = async () => {
    showLoader()
     const response = await fetch("https://asos2.p.rapidapi.com/products/v2/list?store=US&offset=0&categoryId=2084&limit=48&country=US&sort=freshness&currency=USD&sizeSchema=US&lang=en-US", {
       "method": "GET",
       "headers": {
  ...
  return (
    <div className="all" >
      <Top />
      <Header />
      <section className="heroo heroConverse" >
              <div className="container">
                <h2 className="sub-headline1 ">
                  
                  <span className="first-letter1">C</span>onverse</h2>
